...
import { setItemItemNote,setItemItemDescription, setItemItemValue, setItemScheduleDate,
...
export default function SchedulePackageDetail(){
  ...
  dispatch(setItemItemDescription(itemDescription));
dispatch(setItemScheduleDate(scheduleDate))
...
text-gray-900 dark:text-white">Scheduled date</label>

<input type="date" id="large-input" onChange={(e)=>{
      setScheduleDate(e.target.value)
  }}
 className="block p-2 w-full text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
